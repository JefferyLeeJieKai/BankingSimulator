...
public interface IPhotoView {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(com.jefferystudio.bankingsimulator.ImageCropper.PhotoView.PhotoViewAttacher.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(com.jefferystudio.bankingsimulator.ImageCropper.PhotoView.PhotoViewAttacher.OnPhotoTapListener listener);
     ...
     */
    com.jefferystudio.bankingsimulator.ImageCropper.PhotoView.PhotoViewAttacher.OnPhotoTapListener getOnPhotoTapListener();
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(com.jefferystudio.bankingsimulator.ImageCropper.PhotoView.PhotoViewAttacher.OnViewTapListener listener);
     ...
     */
    com.jefferystudio.bankingsimulator.ImageCropper.PhotoView.PhotoViewAttacher.OnViewTapListener getOnViewTapListener();
