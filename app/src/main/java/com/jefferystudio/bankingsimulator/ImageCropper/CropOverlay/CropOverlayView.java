package com.jefferystudio.bankingsimulator.ImageCropper.CropOverlay;
...
public class CropOverlayView extends View implements IGetImageBounds {
    ...
    private int DEFAULT_CROPHEIGHT= 900;
    private int DEFAULT_CROPWIDTH = 300;
    ...
    private int cropHeight = DEFAULT_CROPHEIGHT;
...
//        paint.setAlpha(0);
    ...
    private void init(Context context) {
        ...
        mBackgroundPaint = com.jefferystudio.bankingsimulator.ImageCropper.CropOverlay.utils.PaintUtil.newBackgroundPaint(context);
        mBorderPaint = com.jefferystudio.bankingsimulator.ImageCropper.CropOverlay.utils.PaintUtil.newBorderPaint(context);
        mGuidelinePaint = com.jefferystudio.bankingsimulator.ImageCropper.CropOverlay.utils.PaintUtil.newGuidelinePaint();
